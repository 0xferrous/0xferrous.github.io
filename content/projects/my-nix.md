...
[`pkgs/`](https://github.com/0xferrous/my-nix/blob/main/pkgs/) holds package expressions that are generally useful beyond this repo's own config. They are exposed two ways:
