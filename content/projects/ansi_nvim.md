...
![ansi.nvim demo](https://raw.githubusercontent.com/0xferrous/ansi.nvim/main/demo.png)

Demo shown using [`./test_ansi_real.txt`](https://github.com/0xferrous/ansi.nvim/blob/main/test_ansi_real.txt).
